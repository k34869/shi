...
$('.container').append('<div id=aplayer0></div>');
    const ap0 = new APlayer({
        ...
        preload: 'none',
        audio: [{
            name: `D175在此分享这福杯.mp3`,
            artist: '大本诗歌',
            url: 'https://v-cdn-singlepagepic.soqi.cn/VoiceLibrary_MzE4NTgzNjMwMzY=.voice',
            cover: '/favicon'
        }]
    });
...
$('.container').append('<div id=aplayer1></div>');
    const ap1 = new APlayer({
        ...
        audio: [{
            name: `大本诗歌175首教唱`,
            artist: '大本诗歌',
            url: 'https://v-cdn-singlepagepic.soqi.cn/VoiceLibrary_MzE4NTgzNjMwODc=.voice',
            cover: '/favicon'
        }]
    });
...
$('.container').append('<div id=aplayer2></div>');
    const ap2 = new APlayer({
        ...
        preload: 'none',
        audio: [{
            name: `D175第一节谱词领唱.mp3`,
            artist: '大本诗歌',
            url: 'https://v-cdn-singlepagepic.soqi.cn/VoiceLibrary_MzE4NTgzNjMxMzg=.voice',
            cover: '/favicon'
        }]
    });
